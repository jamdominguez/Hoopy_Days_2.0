...
casos:
    - Si un enemigo le golpea/toca perdera 1 punto
    - Si es golpeado por algún elmento hostil (fuego, pinchos, etc)
    perderá 1 punto
    - Si cae al vacío perderá 1 punto y tendrá que comenzar la fase
...
CU3. Enemigos:
    ...
    - Los enemigos al atacar pueden dañar al jugador y al tocarlo también. Por defecto
    al tocarlo le quitan 1 punto de vida y al dañarlo con un ataque según estén definidos.    
    ...
    - Si toca al jugador le quita 1 punto de vida
    - Lanza una ventosidad cuando en su visión entra el jugador, con un timer de 2 segundos. La
    ventosidad quita 1 punto de vida.
